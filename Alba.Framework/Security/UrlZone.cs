namespace Alba.Framework.Security
{
    ...
    public enum UrlZone
    {
        ...
        Intranet,
        /// <summary>URLZONE_TRUSTED: Zone used for trusted Web sites on the Internet.</summary>
        Trusted,
        /// <summary>URLZONE_INTERNET: Zone used for most of the content on the Internet.</summary>
        Internet,
        /// <summary>URLZONE_UNTRUSTED: Zone used for Web sites that are not trusted.</summary>
        Untrusted,
